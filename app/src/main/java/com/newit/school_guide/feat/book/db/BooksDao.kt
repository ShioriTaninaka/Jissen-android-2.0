...
interface BooksDao {
    ...
    @Query("SELECT * FROM " + Bookmark.TABLE_NAME + " WHERE " + Bookmark.BOOK_ID + " = :bookId" + " AND " + Bookmark.RESOURCE_INDEX + " = :resourceIndex")
    suspend fun getBookmarksForBookByPage(bookId: Long,resourceIndex : Long): List<Bookmark>
