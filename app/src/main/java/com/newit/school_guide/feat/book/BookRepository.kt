...
import com.newit.school_guide.feat.book.db.BooksDao
...
import com.newit.school_guide.feat.book.utils.extensions.authorName
...
class BookRepository(private val booksDao: BooksDao) {
    ...
    suspend fun getBookmarkPages(bookId: Long,page : Long): List<Bookmark> =
        booksDao.getBookmarksForBookByPage(bookId,page)
