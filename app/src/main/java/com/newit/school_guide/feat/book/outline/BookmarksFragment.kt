...
import com.newit.school_guide.databinding.ItemRecycleBookmarkBinding
...
class BookmarksFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getBookmarks().observe(viewLifecycleOwner, {
            ...
            binding.listView.getRecycledViewPool().clear()
...
//            val formattedDate = DateTime(bookmark.creation).toString(DateTimeFormat.shortDateTime())
            val formattedDate = DateTime(bookmark.creation).toString(DateTimeFormat.forPattern("yyyy-MM-dd HH:mm:ss"))
